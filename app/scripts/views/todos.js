/*global yotodo, Backbone, JST*/

yotodo.Views.TodosView = Backbone.View.extend({
    ...
    createTodo: function (event) {
        ...
        if (title) {
            this.collection.create(new yotodo.Models.TodoModel({
                title: title
            }));
    ...
    addTodoItem: function (todo) {
        var view = new yotodo.Views.TodoView({ model: todo });
